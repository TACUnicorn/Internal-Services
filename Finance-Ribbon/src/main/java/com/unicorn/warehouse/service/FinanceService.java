...
public class FinanceService {
    ...
    public BasicResponse<String> transfer(@RequestBody Bill bill) {
        return restTemplate.postForObject("http://FINANCE-SERVICE-CLIENT/finance/transfer",
    ...
    public BasicResponse<List<Bill>> bill(Timestamp start, Timestamp end) {
        return restTemplate.getForObject("http://FINANCE-SERVICE-CLIENT/finance/bill?start="
